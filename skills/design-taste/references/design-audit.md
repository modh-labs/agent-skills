...
A comprehensive checklist for reviewing an existing project. Work through each section systematically, noting every issue found, then apply fixes using the priority order in `SKILL.md` Section 7.
...
- **Import hallucinations.** Check that every import actually exists in the dependency file or the project source.
